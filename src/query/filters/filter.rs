...
mod tests {
    ...
    fn test_filter_creation_null_check() {
        ...
        println!("✅ test_filter_creation_null_check: {:?} | 👌 Null filters | ⚡ {:.3}ms", elapsed, elapsed.as_secs_f64() * 1000.0);
    }
    ...
    fn test_filter_creation_comparisons() {
        ...
        let elapsed = start.elapsed();
        println!("✅ test_filter_creation_comparisons: {:?} | 📊 3 comparisons | ⚡ {:.3}ms", elapsed, elapsed.as_secs_f64() * 1000.0);
    }
    ...
    fn test_filter_creation_pattern_matching() {
        ...
        let elapsed = start.elapsed();
        println!("✅ test_filter_creation_pattern_matching: {:?} | 📜 3 patterns | ⚡ {:.3}ms", elapsed, elapsed.as_secs_f64() * 1000.0);
    }
    ...
    fn test_filter_creation_range() {
        ...
        let elapsed = start.elapsed();
        println!("✅ test_filter_creation_range: {:?} | 📮 2 range filters | ⚡ {:.3}ms", elapsed, elapsed.as_secs_f64() * 1000.0);
    }
    ...
    fn test_filter_creation_set_membership() {
        ...
        let elapsed = start.elapsed();
        println!("✅ test_filter_creation_set_membership: {:?} | 📄 2 set filters | ⚡ {:.3}ms", elapsed, elapsed.as_secs_f64() * 1000.0);
    }
    ...
    fn test_filter_creation_logical_operators() {
        ...
        let elapsed = start.elapsed();
        println!("✅ test_filter_creation_logical_operators: {:?} | 💫 Logical filters | ⚡ {:.3}ms", elapsed, elapsed.as_secs_f64() * 1000.0);
    }
    ...
    fn test_filter_creation_not() {
        ...
        let elapsed = start.elapsed();
        println!("✅ test_filter_creation_not: {:?} | 🚫 NOT filter | ⚡ {:.3}ms", elapsed, elapsed.as_secs_f64() * 1000.0);
    }
    ...
    fn test_filter_creation_regex() {
        ...
        let elapsed = start.elapsed();
        println!("✅ test_filter_creation_regex: {:?} | 📒 Regex filter | ⚡ {:.3}ms", elapsed, elapsed.as_secs_f64() * 1000.0);
    }
    ...
    fn test_complex_nested_filters() {
        ...
        let elapsed = start.elapsed();
        println!("✅ test_complex_nested_filters: {:?} | 📦 Nested filters | ⚡ {:.3}ms", elapsed, elapsed.as_secs_f64() * 1000.0);
    }
}