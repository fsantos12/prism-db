...
pub(crate) fn bind_values<'q>(q: Query<'q, Sqlite, SqliteArguments<'q>>, values: &[DbValue]) -> Query<'q, Sqlite, SqliteArguments<'q>> {
...
fn bind_value<'q>(q: Query<'q, Sqlite, SqliteArguments<'q>>, value: &DbValue) -> Query<'q, Sqlite, SqliteArguments<'q>> {
    ...
    else if value.is::<i8>()            { q.bind(value.get::<i8>().unwrap() as i64) }
    else if value.is::<i16>()           { q.bind(value.get::<i16>().unwrap() as i64) }
    else if value.is::<i32>()           { q.bind(value.get::<i32>().unwrap() as i64) }
    else if value.is::<i64>()           { q.bind(value.get::<i64>().unwrap()) }
    else if value.is::<i128>()          { q.bind(value.get::<i128>().unwrap().to_string()) }
    else if value.is::<u8>()            { q.bind(value.get::<u8>().unwrap() as i64) }
    else if value.is::<u16>()           { q.bind(value.get::<u16>().unwrap() as i64) }
    ...
    else if value.is::<f32>()           { q.bind(value.get::<f32>().unwrap() as f64) }
    else if value.is::<f64>()           { q.bind(value.get::<f64>().unwrap()) }
    else if value.is::<Decimal>()       { q.bind(value.get::<Decimal>().unwrap().to_string()) }
    ...
    else if value.is::<Uuid>()          { q.bind(value.get::<Uuid>().unwrap().to_string()) }
    else if value.is::<JsonValue>()     { q.bind(value.get::<JsonValue>().unwrap().to_string()) }
    else if value.is::<NaiveDate>()     { q.bind(value.get::<NaiveDate>().unwrap().to_string()) }
    else if value.is::<NaiveTime>()     { q.bind(value.get::<NaiveTime>().unwrap().to_string()) }
    else if value.is::<NaiveDateTime>() { q.bind(value.get::<NaiveDateTime>().unwrap().to_string()) }
    else if value.is::<DateTime<Utc>>() { q.bind(value.get::<DateTime<Utc>>().unwrap().to_rfc3339()) }
