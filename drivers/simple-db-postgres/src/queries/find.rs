...
impl<'a> PostgresPreparedFindQuery<'a> {
    pub(crate) fn new(executor: &'a PostgresExecutor, query: FindQuery) -> Self {
...
#[async_trait]
impl PreparedFindQuery for PostgresPreparedFindQuery<'_> {
